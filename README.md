...
Каждая роль заполняет одинаковый набор из 192 утверждений (уровни 2–7). Результаты всех ролей отображаются на одном экране с наложением на радар-чарте, сравнительной таблицей и выявлением «слепых зон».
...
### Уровень оси
Среднее арифметическое уровней компетенций внутри оси, округлённое вниз (диапазон 1–7).

### Общий уровень
Наибольшее N в диапазоне 1–7, при котором:
